// Vendored from libp2p-stream 0.4.0-alpha (MIT), see src/stream/mod.rs.
...
pub(crate) struct Shared {
    ...
    /// [`NetworkBehaviour::poll`](libp2p::swarm::NetworkBehaviour::poll).
...
impl Shared {
    ...
    pub(crate) fn on_dial_failure(&mut self, peer: PeerId, reason: String) {
        ...
        while let Ok(new_stream) = receiver.try_recv() {
            let _ = new_stream
                .sender
                .send(Err(super::OpenStreamError::Io(io::Error::new(
