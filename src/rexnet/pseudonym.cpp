...
constexpr const char* kAdjectives[kPseudonymAdjectives] = {
    "Curious", "Lucky",    "Brave",  "Clever",    "Gentle",   "Swift",      "Quiet",    "Cheerful",
    "Bright",  "Calm",     "Daring", "Eager",     "Fearless", "Friendly",   "Graceful", "Happy",
    "Honest",  "Humble",   "Jolly",  "Keen",      "Kindly",   "Lively",     "Loyal",    "Merry",
    "Mighty",  "Nimble",   "Noble",  "Patient",   "Peaceful", "Playful",    "Polite",   "Proud",
    "Quick",   "Radiant",  "Ready",  "Restless",  "Rugged",   "Sincere",    "Sleepy",   "Smiling",
    "Sunny",   "Spirited", "Steady", "Sturdy",    "Thankful", "Thoughtful", "Tidy",     "Tireless",
    "Trusty",  "Valiant",  "Vivid",  "Wandering", "Watchful", "Whimsical",  "Wise",     "Witty",
    "Zealous", "Amber",    "Autumn", "Golden",    "Silver",   "Crimson",    "Emerald",  "Sapphire",
};

constexpr const char* kNouns[kPseudonymNouns] = {
    "Cat",     "Dog",      "Fox",     "Owl",       "Bear",     "Wolf",     "Otter",   "Badger",
    "Hare",    "Deer",     "Elk",     "Lynx",      "Heron",    "Falcon",   "Raven",   "Robin",
    "Sparrow", "Swallow",  "Finch",   "Magpie",    "Puffin",   "Pelican",  "Swan",    "Crane",
    "Turtle",  "Tortoise", "Gecko",   "Newt",      "Frog",     "Toad",     "Salmon",  "Trout",
    "Perch",   "Marlin",   "Dolphin", "Whale",     "Seal",     "Walrus",   "Penguin", "Puma",
    "Tiger",   "Panther",  "Leopard", "Jaguar",    "Bison",    "Moose",    "Ibex",    "Antelope",
    "Gazelle", "Zebra",    "Camel",   "Llama",     "Alpaca",   "Donkey",   "Pony",    "Stallion",
    "Beetle",  "Cricket",  "Firefly", "Dragonfly", "Hedgehog", "Squirrel", "Marmot",  "Meerkat",
};
